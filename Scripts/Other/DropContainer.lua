...
function DropContainer.calculateSlotItemOffset( self, slotIndex )
	...
	local positionOffset = offsetCornerPosition + sm.vec3.new( 0.25 * ( slotIndex % width ) , 0.25 * ( math.floor( slotIndex / width / depth ) % height ), 0.25 * ( math.floor( slotIndex / width ) % height ) )
