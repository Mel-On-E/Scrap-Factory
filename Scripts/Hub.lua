...
dofile("$CONTENT_DATA/Scripts/Shop.lua")
...
---@class Hub : ToolClass
---@field cl client
---@field seatedEquiped boolean
---@field equipped boolean
---@field wantsEquip boolean
---@field tool Tool
Shop = class()
...
function Shop:client_onCreate()
    ...
    if self.tool:isLocal() then
        ...
        Shop.client_onCreate()
    end

    self:client_onRefresh()
end

function Shop:client_onRefresh()
    self:client_onCreate()
    self:cl_loadAnimations()
end

function Shop:client_onUpdate(dt)
...
function Shop:client_equipWhileSeated()
...
function Shop:client_onUnequip()
    self.cl.wantsEquip = false
    self.cl.seatedEquiped = false
...
function Shop:cl_loadAnimations()
    -- TP
